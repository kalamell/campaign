...
<?php echo form_open_multipart('member/update_vote');?>
<div class="modal-body">
    <input type="hidden" name="campaign_id" id="campaign_id" value="<?php echo $campaign_id;?>">
    <input type="hidden" name="vote_id" value="<?php echo $r->vote_id;?>">

  <div class="row">
    <div class="form-group col-md-12">
      <label for="title">ชื่อชุด</label>
      <input type="text" class="form-control required" value="<?php echo $r->title;?>"  id="title" name="title" placeholder="">
    </div>

    <div class="form-group col-md-12">
      <label for="mobile">เบอร์ติดต่อ</label>
      <input type="text" class="form-control required" value="<?php echo $r->mobile;?>"  id="mobile" name="mobile" placeholder="">
    </div>
    ...
    <div class="form-group col-md-6">
    	...
    	<div class="radio">
    		<label>
    			<input type="radio" name="type" value="เดี่ยว" <?php echo $r->type == 'เดี่ยว' ? 'checked' : '';?> id="type"> ประกวดเดี่ยว 
    		</label>
    	</div>

    	<div class="radio">
    		<label>
    			<input type="radio" name="type" value="กลุ่ม" <?php echo $r->type != 'เดี่ยว' ? 'checked' : '';?> id="type"> ประกวดกลุ่ม 
    		</label>
    	</div>
