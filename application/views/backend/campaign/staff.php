	...
	<div class="row">
		...
		<div class="col-md-12">
			<ol class="breadcrumb">
			  ...
			  <li class="active">ข้อมูลผู้เข้าร่วมงานแคมเปญ <?php echo $f->campaign_name;?></li>
			</ol>
		</div>
		...
		<div class='col-md-12'>
			<div class="panel panel-default">
			  ...
			  <div class="panel-body">
			  	...
			  	<?php echo form_open_multipart('backend/campaign/do_staff', array('class' => 'form-inline'));?>

			  	<input type="hidden" name="campaign_id" value="<?php echo $f->campaign_id;?>">

			  	<div class="form-group">
			  		<input type="file" class="form-control" name="file"> <button type="submit" class="btn btn-info btn-sm"><i class="fa fa-cloud"></i> Upload</button> <a href="<?php echo site_url('backend/campaign/reset_member/'.$f->campaign_id);?>" onclick="javascript:return confirm('ต้องการ ยกเลิกการจับรางวัลหรือไม่ ?');" class="btn btn-default btn-sm">ล้างข้อมูล</a>
			  				...
			  				<?php foreach($rs as $r):?>
			  					<tr>
			  						<td style="text-align: center;">
			  							<div class="btn-group">
			  								<a href="<?php echo site_url('backend/campaign/delete_staff/'.$r->campaign_id.'/'.$r->id);?>" onclick="javascript:return confirm('ต้องการลบหรือไม่ ?');" class="btn btn-default btn-sm"><i class="fa fa-trash"></i></a>
